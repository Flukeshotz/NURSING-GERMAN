...
module.exports = function load() {
  ...
  const code = s.slice(0, cut) + "\n" + back + `
    ...
    globalThis.APP = {PEOPLE,SHIFTS,BODY,WORDS,DOCS,EMERGENCY,DRILL,TR,GOALS,LEVELS,SPELL,DOC_KEYS,LETTER,levelDeck,levelTitle,exchangesFor,goalCards,backParts,wordByEn,slugId,plain,slotText};`;
