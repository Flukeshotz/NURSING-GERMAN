...
| Reuse organ words in later levels (A1) | 10 new ward exchanges in 8 later levels reuse the organs in context, e.g. Symptoms: „Mein Herz schlägt so schnell.", „Mein Magen tut weh."; Vital signs: kidney value (Kreatinin); Medication: „Ist die Tablette für das Herz?", „Die Bauchspeicheldrüse macht zu wenig Insulin."; Instructions: „Machen Sie bitte den Oberkörper frei."; Colleagues: „Herr Yılmaz hat Nierenschmerzen."; Admission: „Ich habe eine Nierenkrankheit."; Night round: „Ich bekomme schlecht Luft."; Toilet: „Es brennt beim Wasserlassen." … „Vielleicht ist es die Blase." Plus 2 words: das Insulin, der Oberkörper. 12 new photos (2 regenerated after review). Now 419 cards, 474 questions. |
